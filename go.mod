...
require (
	...
	github.com/openshift-kni/oran-o2ims/api/hardwaremanagement v0.0.0-20250326123606-1734d8813393
...
replace github.com/openshift-kni/oran-hwmgr-plugin/api/hwmgr-plugin => ./api/hwmgr-plugin

// CVE-2025-22869 is resolved in golang.org/x/crypto v0.35.0, which requires go-1.23. This replace can be dropped once upgraded
